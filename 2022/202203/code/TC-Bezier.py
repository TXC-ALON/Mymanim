...
class LinearBezierCurve(Scene):
    ...
    def construct(self):
        ...
        P = VGroup(P0, P1).set_color(PINK)

        P0_P1 = Line(P0, P1).set_color(BLUE)
...
class QuadraticBezierCurve(Scene):
    ...
    def construct(self):
        ...
        P = VGroup(P0, P1, P2).set_color(PINK)
...
class FourthOrderBezierCurve(Scene):
    ...
    def construct(self):
        ...
        P = VGroup(P0, P1, P2, P3, P4).set_color(PINK)
        
        P0_P1 = Line(P0, P1)
        P1_P2 = Line(P1, P2)
        P2_P3 = Line(P2, P3)
        P3_P4 = Line(P3, P4)
        P_lines = VGroup(P0_P1, P1_P2, P2_P3, P3_P4).set_color(PINK)
...
class FifthOrderBezierCurve(Scene):
    ...
    def construct(self):
        ...
        P = VGroup(P0, P1, P2, P3, P4, P5).set_color(PINK)
        ...
        P3_P4 = Line(P3, P4)
        P4_P5 = Line(P4, P5)
        P_lines = VGroup(P0_P1, P1_P2, P2_P3, P3_P4, P4_P5).set_color(PINK)
